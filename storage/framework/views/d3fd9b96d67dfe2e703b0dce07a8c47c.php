                            ...
                            echo "<tr>
                                ...
                                <td>
                                    <form action="/orders_delete" method="post" class="d-inline">  
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="id" value="<?php echo e($orders_detail_temp->id); ?>" />
                                        <?php
                                        echo "
...
<?php echo $__env->make('layout.menu_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SKRIPSI 2026\UPH\- Melvin Wijaya\pelanggan\resources\views/orders/create.blade.php ENDPATH**/ ?>