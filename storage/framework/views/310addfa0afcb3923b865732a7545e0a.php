...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- Start Nav Order -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="/orders_user">
...
</html><?php /**PATH D:\SKRIPSI 2025\UPH\- Melvin Wijaya\pelanggan\resources\views/layout/menu_user.blade.php ENDPATH**/ ?>