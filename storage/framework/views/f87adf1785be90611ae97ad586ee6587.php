            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="/loginPost" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Tidak punya akun? Mohon hubungi bagian informasi.</p>
                    </div>
                  </form>
...
</html><?php /**PATH D:\SKRIPSI 2026\UPH\- Melvin Wijaya\pelanggan\resources\views/index.blade.php ENDPATH**/ ?>